...
This plot shows that frequent words ("said", "people", "also") are neutral while less frequenty words such as "borrowing", "unemployment", "emerging" and "efficient" are  either negative or positive.
