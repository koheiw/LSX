...
You can visualize the polarity of words using `textplot_terms()`. If you pass a dictionary to `highlighted`, words are plotted in different colors. `data_dictionary_LSD2015` is a widely-used sentiment dictionary.

```{r plot-sentiment-term, warning=FALSE}
...
```{r plot-sentimnet-emoji, warning=FALSE}
